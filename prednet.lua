...
function PredNet(nlayers, input_stride, poolsize, mapss, clOpt, testing)
   ...
   -- This module creates the PredNet network model, defined as:
   ...
   -- generating network layers (two for loops):
   ...
   for L = 1, nlayers do
      if testing then print('PredNet model: creating layer:', L) end 
